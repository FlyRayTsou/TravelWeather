...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="is-preload">
        <div id="wrapper">
            <header id="header">
                <h1>
                    <a href="https://www.linkedin.com/in/ray-tsou-5066b1179/"><strong>Powered</strong> by スウメイケン</a>
                </h1>
                <nav>
                    <ul>
                    ...
                    <div>
                        ...
                        <section>
                            ...
                            <ul class="icons">
                                ...
                                <li>
                                    <a href="https://www.linkedin.com/in/ray-tsou-5066b1179/" class="icon brands fa-linkedin-in">
